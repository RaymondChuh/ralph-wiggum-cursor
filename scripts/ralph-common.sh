...
run_iteration() {
  ...
  # Build cursor-agent command as an array to preserve special characters in the prompt
  local cmd_args=(cursor-agent -p --force --output-format stream-json --model "$MODEL")
